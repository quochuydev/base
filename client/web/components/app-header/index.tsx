    ...
    return (
        ...
        >
                ...
                <NavLink href="/blog">
                    <NavA flex="1 0 auto">
                        <Flex alignItems="center" justifyContent="center">
                            <Icon fill="theme.header.fill" size="16px" name="home" mt="2px" mr={1}></Icon>home
                        </Flex>
                    </NavA>
                </NavLink>
                <NavLink href="/about">
                    <NavA flex="1 0 auto">
                        <Flex alignItems="center" justifyContent="center">
                            <Icon fill="theme.header.fill" size="16px" name="user" mt="2px" mr={1}></Icon>user
                        </Flex>
                    </NavA>
                </NavLink>
            ...
            <Flex alignItems="center" ml={5}>
                ...
                <UiLink display={['none', 'block']} href="https://github.com/quochuydev" isExternal={true}>
